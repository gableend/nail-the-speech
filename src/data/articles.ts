...
export const articles: Article[] = [
  ...
  // ─── wedding-speech-transitions ───
  {
    ...
    relatedExamples: ['lighthearted-speech', 'lighthearted-speech'],
  ...
  // (4 duplicate articles removed: wedding-toast-vs-wedding-speech,
  //  best-wedding-speech-opening-lines, wedding-speech-toast-ending, quotes-in-wedding-speech.
  //  Originals retained above.)
  ...
  // ─── groom-speech-guide ───
  {
    ...
    relatedExamples: ['groom-speech', 'groom-to-bride-speech', 'lighthearted-speech'],
  ...
  // ─── mention-bride-best-man-speech ───
  {
    ...
    relatedExamples: ['best-man-speech', 'lighthearted-speech'],
