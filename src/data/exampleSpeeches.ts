...
export const exampleSpeeches: ExampleSpeech[] = [
  ...
  },
  {
    ...
    content: `Hi everyone, buenas noches! Today we celebrate Aidan and Marco – two grooms, two legends, and two men who somehow decided Playa Blanca was the perfect spot to make it official. I've been friends with Aidan since university, which means I've witnessed every questionable haircut, every failed attempt at salsa dancing, and every regrettable tequila shot. When he met Marco, I thought, 'Finally – someone patient enough to deal with him.' Marco is charming, stylish, and has an actual skincare routine. Aidan thinks SPF is a personality type. But together, they just work – Aidan provides the chaos, Marco brings the calm, and Playa Blanca provides the rum. So let's raise a glass – to Aidan and Marco, who prove that true love is about balance, compromise, and occasionally letting your partner pick the holiday destination. To the grooms!`,
  ...
  },
  {
    ...
    content: `Good evening. I was told to keep this short, so I'll do my best. If I start rambling, someone throw a bread roll. So here's my attempt. Dave is one of the funniest, clumsiest, and most loyal men I know. He doesn't just fall down stairs – he falls head over heels for the right woman. And here she is. To Dave and Orla – proof that love can survive pratfalls, broken shoes, and one best mate with dodgy jokes. To the newlyweds.`,
