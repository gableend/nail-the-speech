  ...
  return (
    <div className="min-h-screen bg-[#faf7f4] flex items-center justify-center">
      <div className="text-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#c44578] mx-auto mb-4" />
        <p className="text-[#756c64]">Loading dashboard...</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#faf7f4] flex items-center justify-center">
      <div className="text-center max-w-md mx-auto px-4">
        ...
        <Link
          href="/sign-in"
          className="inline-block bg-[#c44578] hover:bg-[#b33c6c]/90 text-white rounded-full px-6 py-2 font-medium"
        >
          Sign In Again
        </Link>
      </div>
