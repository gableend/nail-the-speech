...
export const helpArticles: HelpArticle[] = [
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { href: "/generator", label: "Try the speech generator" },
      { href: "/advice/how-to-make-wedding-speech-personal", label: "Tips for personalising your speech" },
    ],
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { href: "/advice/wedding-speech-mistakes", label: "Full guide to speech mistakes" },
    ],
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { href: "/advice/how-to-be-funny-wedding-speech", label: "Full humour guide" },
    ],
  ...
  },
  {
    ...
    internalLinks: [
      ...
      { href: "/advice/wedding-speech-nerves", label: "Full guide to managing nerves" },
      { href: "/advice/how-to-practice-wedding-speech", label: "Practice tips" },
    ],
